...
quiz = [
    ...
    {"question": "What does 'JavaScript'.toUpperCase().slice(0, 4)?", "options": ["'JAVA'", "'java'", "'JAVAS'", "Error"], "answer": "'JAVA'"},
    {"question": "What does [2, 4, 6].filter(x => x > 3) return?", "options": ["[2, 4]", "[4, 6]", "[6]", "Error"], "answer": "[4, 6]"},
    {"question": "What is parseInt('15.9')?", "options": ["15", "16", "15.9", "Error"], "answer": "15"},
    ...
    {"question": "What does 'TeSt'.toLowerCase()?", "options": ["'test'", "'TeSt'", "'TEST'", "Error"], "answer": "'test'"},
    ...
    {"question": "What does try { null.toString(); } catch (e) { console.log(e.name); }?", "options": ["'TypeError'", "'ReferenceError'", "'SyntaxError'", "Nothing"], "answer": "'TypeError'"},
    {"question": "What is 'Test Case'.length?", "options": ["8", "9", "10", "Error"], "answer": "9"},
    {"question": "What does Math.random() * 5 likely to produce?", "options": ["0 to 4.999...", "0 to 5", "1 to 5", "Error"], "answer": "0 to 4.999..."},
    ...
    {"question": "What does try { console.log(undefinedVar); } catch (e) { console.log('Caught'); }?", "options": ["'Caught'", "undefined", "Error", "Nothing"], "answer": "'Caught'"},
    ...
    {"question": "What does this loop output: let count = 0; for (let i = 0; i < 5; i++) { if (i === 3) continue; count++; } console.log(count);?", "options": ["4", "5", "3", "Error"], "answer": "4"},
    {"question": "What does parseFloat('12.34.56')?", "options": ["12.34", "12.3456", "NaN", "Error"], "answer": "12.34"},
    ...
    {"question": "What does 'CODE'.toLowerCase().length?", "options": ["4", "5", "6", "Error"], "answer": "4"},
    {"question": "What does [1, 2].reduce((a, b) => a * b) return?", "options": ["2", "3", "1", "Error"], "answer": "2"},
    {"question": "What does this loop output: let flag = false; for (let i = 0; i < 5; i++) { if (i > 3) flag = true; } console.log(flag);?", "options": ["true", "false", "undefined", "Error"], "answer": "true"},
    {"question": "What does Number('42') return?", "options": ["42", "'42'", "NaN", "Error"], "answer": "42"},
    {"question": "What does 'JavaScript'.indexOf('Script')?", "options": ["4", "5", "6", "Error"], "answer": "4"},
    ...
    {"question": "What does try { let arr = []; arr[0](); } catch (e) { console.log(e.name); }?", "options": ["'TypeError'", "'ReferenceError'", "'SyntaxError'", "Nothing"], "answer": "'TypeError'"},
    ...
    {"question": "What does parseInt('abc')?", "options": ["0", "NaN", "'abc'", "Error"], "answer": "NaN"},
    ...
    {"question": "What does 'Hello World'.indexOf('z')?", "options": ["-1", "0", "10", "Error"], "answer": "-1"},
    ...
    {"question": "What does try { let x; x.a; } catch (e) { console.log(e.name); }?", "options": ["'TypeError'", "'ReferenceError'", "'SyntaxError'", "Nothing"], "answer": "'TypeError'"},
    ...
    {"question": "What does parseInt('-5.7')?", "options": ["-5", "-6", "NaN", "Error"], "answer": "-5"},
    {"question": "What does 'HELLO'.toLowerCase()?", "options": ["'hello'", "'HELLO'", "'Hello'", "Error"], "answer": "'hello'"},
    ...
    {"question": "What does 'Hello World'.indexOf('World', 7)?", "options": ["6", "7", "-1", "Error"], "answer": "-1"},
    ...
    {"question": "What does try { let x = 1 / 0; } catch (e) { console.log('Error'); }?", "options": ["'Error'", "Infinity", "Nothing", "Error"], "answer": "Nothing"},
    ...
    {"question": "What does 'JavaScript'.toLowerCase().length?", "options": ["9", "10", "11", "Error"], "answer": "10"},
    ...
    {"question": "What does this loop output: let x = 0; for (let i = 1; i <= 3; i++) { x += i * 2; } console.log(x);?", "options": ["6", "12", "9", "Error"], "answer": "12"},
