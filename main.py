...
quiz = [
    ...
    },
    {
        ...
        "options": ["Adds or removes 'valid' class based on input length", "Sets the input value to 'valid'", "Checks if the input is empty", "Triggers an event"],
    ...
    },
    {
        ...
        "options": ["if (document.getElementById('input').value.trim() !== '')", "if (document.getElementById('input').value === null)", "if (document.getElementById('input').length > 0)", "if (document.getElementById('input').text !== '')"],
    ...
    },
    {
        ...
        "options": ["Logs 'Selected' if dropdown has a value, else 'Not selected'", "Sets the dropdown value", "Triggers a change event", "Checks if dropdown is visible"],
    ...
    },
    {
        ...
        "options": ["if (document.querySelector('input[name=group]:checked'))", "if (document.getElementsByName('group').checked)", "if (document.querySelector('input.group').value)", "if (document.getRadio('group').selected)"],
    ...
    },
    {
        ...
        "options": ["Logs 'Checked' if a radio button is selected, else 'Not checked'", "Logs the value of the radio button", "Triggers a click event", "Throws an error if no radio is selected"],
    ...
    },
    {
        ...
        "options": ["/^\\d{5}(-\\d{4})?$/", "/^\\d{5}$/", "/^\\d{5}-\\d{4}$/", "/^\\d{9}$/"],
        "answer": "/^\\d{5}(-\\d{4})?$/",
        "difficulty": "Medium",
    ...
    },
    {
        ...
        "options": ["Validates email and toggles 'valid' class", "Sets email field value", "Triggers email field event", "Clears email field"],
    ...
    },
    {
        ...
        "options": ["Logs 'Invalid input'", "Logs 'Error'", "Throws an error", "Logs undefined"],
    ...
    },
    {
        ...
        "options": ["Shows an alert on button click", "Changes button text", "Disables the button", "Redirects the page"],
    ...
    },
    {
        ...
        "options": ["Sets the first element with class 'test' to 'New text'", "Sets all elements with class 'test' to 'New text'", "Appends 'New text' to the first element", "Removes the first element"],
    ...
    },
    {
        ...
        "options": ["Sets the 'data-value' attribute of #box to 'test'", "Gets the 'data-value' attribute", "Removes the 'data-value' attribute", "Adds a class 'test' to #box"],
    ...
    },
    {
        ...
        "options": ["image.jpg", "undefined", "img", "Error"],
        "answer": "image.jpg",
        "difficulty": "Medium",
    ...
    },
    {
        ...
        "options": ["Appends a new div with 'Hello' to #container", "Replaces #container with a new div", "Prepends a div to #container", "Removes #container"],
    ...
    },
    {
        ...
        "options": ["Inserts a new <p> before #target", "Inserts a new <p> after #target", "Replaces #target with a <p>", "Appends a <p> to #target"],
    ...
    },
    {
        ...
        "options": ["Sets #output’s text to 'Test'", "Sets #output’s value to 'Test'", "Appends 'Test' to #output", "Removes #output"],
    ...
    },
    {
        ...
        "options": ["Hello", "undefined", "greet", "Error"],
        "answer": "Hello",
        "difficulty": "Medium",
    ...
    },
    {
        ...
        "options": ["Sets the href of #link to 'new-url'", "Gets the href of #link", "Removes the href attribute", "Triggers a click on #link"],
    ...
    },
    {
        ...
        "options": ["Logs 'Navigated' on history navigation", "Reloads the page", "Triggers a popstate event", "Opens a new window"],
    ...
    },
    {
        ...
        "options": ["Sets #box width to 50% of viewport on window resize", "Resizes the window", "Sets #box height to 50vw", "Triggers a resize event"],
    ...
    },
    {
        ...
        "options": ["Toggles 'valid' class based on input length >= 5", "Sets input value to 'valid'", "Clears the input", "Triggers a keypress event"],
    ...
    },
    {
        ...
        "options": ["Logs 'Valid' or 'Invalid' based on dropdown selection", "Sets dropdown value to 'Valid'", "Triggers a change event", "Hides the dropdown"],
    ...
    },
    {
        ...
        "options": ["Unchecks all radio buttons in the group", "Checks all radio buttons", "Gets the values of radio buttons", "Removes radio buttons"],
    ...
    },
    {
        ...
        "options": ["Validates a 5-digit ZIP code and toggles 'valid' class", "Sets ZIP code value", "Triggers a keypress event", "Clears the ZIP field"],
    ...
    },
    {
        ...
        "options": ["Sets #error’s text to 'Fail'", "Logs 'Fail' to console", "Throws an error", "Clears #error"],
    ...
    },
    {
        ...
        "options": ["Logs 'Hovered' when the button is moused over", "Logs 'Hovered' on click", "Changes button text", "Hides the button"],
    ...
    },
    {
        ...
        "options": ["Adds 'active' class to the first element with data-test attribute", "Adds 'active' to all elements with data-test", "Sets data-test to 'active'", "Removes the first element"],
    ...
    },
    {
        ...
        "options": ["P", "p", "Paragraph", "undefined"],
        "answer": "P",
        "difficulty": "Medium",
    ...
    },
    {
        ...
        "options": ["Toggles 'has-content' class based on child elements", "Counts all nodes in #container", "Adds content to #container", "Removes #container"],
    ...
    },
    {
        ...
        "options": ["Logs 'desc'", "Logs 'img'", "Logs undefined", "Throws an error"],
        "answer": "Logs 'desc'",
        "difficulty": "Medium",
    ...
    },
    {
        ...
        "options": ["Removes the 'data-value' attribute from #box", "Sets 'data-value' to null", "Gets 'data-value'", "Adds 'data-value' class"],
    ...
    },
    {
        ...
        "options": ["Appends a new div to the body", "Replaces the body with a div", "Creates a div without adding it", "Throws an error"],
    ...
    },
    {
        ...
        "options": ["Inserts a new <p> after #target", "Inserts a new <p> before #target", "Replaces #target with a <p>", "Appends a <p> to #target"],
    ...
    },
    {
        ...
        "options": ["Sets #output’s data-value to 10", "Sets #output’s text to 10", "Appends 10 to #output", "Removes #output"],
    ...
    },
    {
        ...
        "options": ["Logs 4", "Logs undefined", "Logs 'calc'", "Throws an error"],
        "answer": "Logs 4",
        "difficulty": "Medium",
    ...
    },
    {
        ...
        "options": ["Sets #name’s text to 'Bob'", "Sets #name’s value to 'Bob'", "Appends 'Bob' to #name", "Throws an error"],
    ...
    },
    {
        ...
        "options": ["Logs 'Sound'", "Logs undefined", "Logs 'Animal'", "Throws an error"],
        "answer": "Logs 'Sound'",
        "difficulty": "Medium",
    ...
    },
    {
        ...
        "options": ["Sets #output’s text to 'Has x'", "Sets #output’s value to 'x'", "Logs 'Has x' to console", "Throws an error"],
    ...
    },
    {
        ...
        "options": ["Sets #status text to 'Navigated' on history navigation", "Reloads the page", "Triggers a popstate event", "Opens a new window"],
    ...
    },
    {
        ...
        "options": ["Sets html element width to full viewport", "Sets html element height to full viewport", "Hides the html element", "Scrolls the page"],
    ...
    },
    {
        ...
        "options": ["Sets #box height to 50% of viewport on resize", "Resizes the window", "Sets #box width to 50vh", "Triggers a resize event"],
    ...
    },
    {
        ...
        "options": ["Sets #status text to 'Popup blocked' if popup fails", "Opens a new window", "Logs 'Popup blocked' to console", "Throws an error"],
    ...
    },
    {
        ...
        "options": ["Toggles 'valid' class if input is alphabetic", "Sets input value to alphabetic", "Clears the input", "Triggers a keypress event"],
    ...
    },
    {
        ...
        "options": ["Sets #status text based on dropdown selection", "Sets dropdown value", "Triggers a change event", "Hides the dropdown"],
    ...
    },
    {
        ...
        "options": ["Logs 'Selected' or 'Not selected' based on radio button", "Checks all radio buttons", "Sets radio button value", "Removes radio buttons"],
    ...
    },
    {
        ...
        "options": ["Validates a 9-digit ZIP code and toggles 'valid' class", "Sets ZIP code value", "Triggers a keypress event", "Clears the ZIP field"],
    ...
    },
    {
        ...
        "options": ["Sets #error’s text to 'Error'", "Logs 'Error' to console", "Throws an error", "Clears #error"],
    ...
    },
    {
        ...
        "options": ["Toggles 'active' class on double-click", "Adds 'active' class on click", "Removes 'active' class", "Triggers a click event"],
    ...
    },
    {
        ...
        "options": ["Adds 'selected' class to elements with data-value='1'", "Sets data-value to 'selected'", "Removes elements with data-value='1'", "Triggers an event"],
    ...
    },
    {
        ...
        "options": ["Removes #box from the DOM", "Hides #box", "Replaces #box", "Appends #box"],
    ...
    },
    {
        ...
        "options": ["Toggles the 'title' attribute on #box", "Sets 'title' to 'Tooltip' always", "Removes #box", "Gets the 'title' value"],
    ...
    },
    {
        ...
        "options": ["Logs undefined", "Logs 1", "Throws an error", "Logs 'x'"],
    ...
    },
    {
        ...
        "options": ["Sets #count’s text to 5", "Sets #count’s value to 5", "Appends 5 to #count", "Removes #count"],
    ...
    },
    {
        ...
        "options": ["Prevents form submission and sets #status to 'Submitted'", "Submits the form", "Clears the form", "Triggers a click event"],
    ...
    },
    {
        ...
        "options": ["Logs 'test'", "Logs undefined", "Logs 'input'", "Throws an error"],
        "answer": "Logs 'test'",
        "difficulty": "Medium",
    ...
    },
    {
        ...
        "options": ["Validates email and toggles 'valid' class", "Sets email value", "Triggers a keypress event", "Clears the email field"],
        "answer": "Validates email and toggles 'valid' class",
        "difficulty": "Medium",
...
if not st.session_state.started:
    ...
    <div style="text-align: center;">
        <p style="color: var(--text-color); font-size: 16px;">Test your JavaScript skills with {len(quiz)} questions!</p>
