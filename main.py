...
# Quiz data (abridged; assumes 50 questions from previous context)
quiz = [
    {
        ...
        "hint": "The alert() function doesn't return user input like prompt()."
    },
    # ... (remaining 49 questions omitted; same as previous)
]
